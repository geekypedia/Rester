/*! grapesjs-custom-code - 0.1.1 */ ! function(e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("grapesjs")) : "function" == typeof define && define.amd ? define(["grapesjs"], t) : "object" == typeof exports ? exports["grapesjs-custom-code"] = t(require("grapesjs")) : e["grapesjs-custom-code"] = t(e.grapesjs)
}(window, function(e) {
    return function(e) {
        var t = {};
        ...
        t.default = r.default.plugins.add("grapesjs-custom-code", function(e) {
            ...
            (0, i.default)(e, o), (0, s.default)(e, o), (0, a.default)(e, o)
        })
    }, function(t, o) {
        t.exports = e
    }, function(e, t, o) {
            ...
            o.addType(r.typeCustomCode, {
                ...
                view: i.view.extend({
                    ...
                    onComponentsChange: function() {
                        var e = this;
                        d && clearInterval(d), d = setTimeout(function() {
                            var o = e.model,
                                n = 1;
        ...
        t.default = function(e) {
            ...
            i && o.add(r.typeCustomCode, n({
                label: '<svg viewBox="0 0 24 24">\n        <path d="M14.6 16.6l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4m-5.2 0L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4z"></path>\n      </svg>\n      <div class="gjs-block-label">' + s + "</div>",
                category: "Extra",
                activate: !0,
                select: !0,
                content: {
        ...
        t.default = function(e) {
            ...
            o.add(r.commandNameCustomCode, n({
                ...
                showCustomCode: function(e) {
                    var t = this.editor,
                        o = this.options.title || i,
                        n = this.getContent(),
                        s = e.get(r.keyCustomCode) || "";
                    t.Modal.open({
                        title: o,
                        content: n
                    }), this.getCodeViewer().setContent(s)
                },
                ...
                getContent: function() {
                    ...
                    return t.className = n + "custom-code", d(t, this.getPreContent()), t.appendChild(o.getElement()), d(t, this.getPostContent()), d(t, this.getContentActions()), o.refresh(), setTimeout(function() {
                        return o.focus()
                    }, 0), t
                },
