  ...
  <div class="panel-body">
		...
		<form id='configForm' action="generate-config.php" method="post">
		    ...
		    <div class="form-group col-md-2">
		      ...
		      <input type="text" class="form-control" id="pypy_version" placeholder="Enter PyPy version" name="pypy_version" required value="7.1.1">
		    </div>
			...
			<div class="row row-margin">
			    <div class="form-group col-md-3">
			    	<a href="../api" target="_blank" class="btn btn-info round-btn-med round-btn" onclick="openLink()">LAUNCH</a>	
			    </div>
			    <div class="form-group col-md-1">
			    </div>
			    <div class="form-group col-md-3">
